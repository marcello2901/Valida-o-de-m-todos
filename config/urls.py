...
urlpatterns = [
    ...
    path(
        "estudos/<int:estudo_id>/qualitativas/",
        estudos_views.qualitativas,
        name="qualitativas_estudo",
    ),
    ...
    path("estudos/<int:estudo_id>/desfazer/", estudos_views.desfazer, name="desfazer_estudo"),
