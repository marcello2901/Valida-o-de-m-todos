...
class Mensurando(models.Model):
    ...
    # O intervalo de referência NÃO mora aqui.
    #
    # Ele é da metodologia, não do analito: dois imunoensaios de FT4 imprimem
    # faixas diferentes no laudo, e é por isso que o estudo declara um intervalo
    # para o método de comparação e outro para o método em teste. Um valor único
    # no analito servia de reserva para os dois — o que é justamente o erro que a
    # concordância clínica existe para detectar, porque classificar as amostras
    # dos dois métodos pela mesma faixa esconde o desacordo que se quer medir.
